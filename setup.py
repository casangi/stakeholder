...
if os.path.exists(os.getcwd() + '/data/E2E6.1.00034.S_tclean.ms') is False:
...
if os.path.exists(os.getcwd() + '/data/test_stk_alma_pipeline_imaging_exp_dicts.json') is False:
