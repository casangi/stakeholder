    ...
    def clean1(self):    
        ...
        if self.parallel:
            ...
            bmin_dict, bmaj_dict, pa_dict = \
                self.cube_beam_stats(image=self.img+'.image')
        ...
        im_stats_dict = self.image_stats(image=self.img+'.image', 
        ...
        # .pb report
        pb_stats_dict = self.image_stats(image=self.img+'.pb', 
        ...
        # .residual report
        resid_stats_dict = self.image_stats(image=self.img+'.residual', 
                                            fit_region = 'ellipse[[11.47881897deg, -73.25881015deg], [9.0414arcsec, 8.4854arcsec], 90.00000000deg]')
        ...
        test_dict['test_standard_cube']['images'].extend((self.img+'.image.moment8.png',self.img+'.residual.moment8.png'))
        test_dict['test_standard_cube']['images'].append(self.img+'.image.profile.png')
...
#            savedict['sumwt_stats_dict']=sumwt_stats_dict
            ...
            self.save_dict_to_file(self.test_name,savedict, self.test_name+'_current_metrics')
